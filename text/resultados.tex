...
\subsection{Tamanho das partições} \label{sec:resultados-tamanho}
    ...
    \begin{figure}[htb]
        ...
        \begin{subfigure}[b]{\textwidth}
            \centering
            \resizebox{0.6\textwidth}{!}{\import{images}{r50-s-5-10-n220-ke0.5-ki0.1-kg0.1-dist1-3-3-3-iter100-part200.pgf}}
        ...
        \begin{subfigure}[b]{\textwidth}
            \centering
            \resizebox{0.6\textwidth}{!}{\import{images}{r-5-10-s-5-30-n80-ke0.5-ki0.1-kg0.1-dist1-3-3-3-iter100-part200.pgf}}
