...
\subsection{Exemplo de Execução}
    ...
    \begin{figure}[htb]
        ...
        \begin{subfigure}[b]{0.33\textwidth}
            \centering
            \resizebox{\textwidth}{!}{\import{images/example}{iter-01.pgf}}
        ...
        \begin{subfigure}[b]{0.33\textwidth}
            \centering
            \resizebox{\textwidth}{!}{\import{images/example}{iter-05.pgf}}
