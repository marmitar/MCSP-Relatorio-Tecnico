...
\todo[inline]{(Gabriel) \st{Explicar melhor esse deslocamento. Recomendo que vocês coloquem explicitamente a equação que gera a nova posição com base nas valores desse ultimo parágrafo, na posição anterior e nos melhorer individiais e globais.}}
