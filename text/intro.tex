...
\subsection{Definições}
    ...
    Seja uma string $A$, com $\abs{A}$ caracteres. Denotamos por $A_i$ o i-ésimo caractere de $A$. O conjunto de caracteres distintos de $A$ é chamado de alfabeto de $A$ e 
    
    \begin{definition}[Strings Balanceadas]
        Duas strings $A$ e $B$ são ditas balanceadas se o número de ocorrências dos caracteres de $A$ for igual ao dos caracteres de $B$.
    \end{definition}
