...
\begin{figure}
    ...
    \caption{\textcolor{red}{Grafo representando duas instâncias do MCSP, sendo ambas com as mesmas strings mas em ordens diferentes. Os vértices do grafo são índices da primeira string da instância e, em cada aresta do grafo, está evidenciada a substring equivalente que pertence à segunda string.}}
    \label{fig:grafo}
\end{figure}
