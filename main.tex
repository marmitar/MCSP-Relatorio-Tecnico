...
\st{- A referência para o criterion fica melhor como footnote na hora que vocês mensionam ele (a menos que vocês coloquem uma citação para algum artigo que o descreva).}\\
}
